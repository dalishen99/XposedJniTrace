...
public enum FieldNamingPolicy implements FieldNamingStrategy {
  ...
  /**
   * Using this naming policy with Gson will modify the Java Field name from its zhenxi cased
  ...
  /**
   * Converts the field name that uses zhenxi-case define word separation into
